	  ...
	  <h3>Employee's Information</h3>
	    ...
	    <div class="form-group col-md-12" style="padding: 0">
	      <div class="col-md-8" style="padding: 0 5px 0 0">
	        {{Form::text('child_one', null, ['class' => 'form-control', 'placeholder' => "Child's Name"])}} 
	      </div>
	      <div class="col-md-4" style="padding: 0">
	        {{Form::text('child_one_age', null, ['class' => 'form-control', 'placeholder' => "Child's Age"])}}
	      </div>
	      <div class="col-md-8" style="padding: 0 5px 0 0">
	        {{Form::text('child_two', null, ['class' => 'form-control', 'placeholder' => "Child's Name"])}} 
	      </div>
	      <div class="col-md-4" style="padding: 0">
	        {{Form::text('child_two_age', null, ['class' => 'form-control', 'placeholder' => "Child's Age"])}}
	      </div>
	      <div class="col-md-8" style="padding: 0 5px 0 0">
	        {{Form::text('child_three', null, ['class' => 'form-control', 'placeholder' => "Child's Name"])}} 
	      </div>
	      <div class="col-md-4" style="padding: 0">
	        {{Form::text('child_three_age', null, ['class' => 'form-control', 'placeholder' => "Child's Age"])}}
	      </div>
	      <div class="col-md-8" style="padding: 0 5px 0 0">
	        {{Form::text('child_four', null, ['class' => 'form-control', 'placeholder' => "Child's Name"])}} 
	      </div>
	      <div class="col-md-4" style="padding: 0">
	        {{Form::text('child_four_age', null, ['class' => 'form-control', 'placeholder' => "Child's Age"])}}
	      </div>
	      <div class="col-md-8" style="padding: 0 5px 0 0">
	        {{Form::text('child_five', null, ['class' => 'form-control', 'placeholder' => "Child's Name"])}} 
	      </div>
	      <div class="col-md-4" style="padding: 0">
	        {{Form::text('child_five_age', null, ['class' => 'form-control', 'placeholder' => "Child's Age"])}}
	      </div>
        </div>
