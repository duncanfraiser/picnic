...
<div class="container">
  <div class="col-md-8 col-md-offset-2">
    ...
    {{-- <center><h1 style="color:red">Registration Opens April 12, 2017</h1></center> --}}
     ...
     <div class="col-md-8 col-md-offset-2">
    <p><center><strong>Cars, Trucks, Motorcycles & Tractors Welcome<br/> Saturday, May 20, 2017<br/>Setup begins at 9 a.m.<br/>Voting closes at 12 a.m. <br/>WINNERS will be announced at 1 p.m.</strong></center></p></div>
	<div class="col-md-8 col-md-offset-2" style="margin-bottom: 3em">
	  {{Form::open(['action' => 'InviteeController@store'])}}
	    ...
	    <div class="form-group">
	      ...
	      @else
	        {{Form::email('invitee_email', null, ['class' => 'form-control', 'placeholder' => "Please Enter Invitee Email Address"])}}
	      @endif
	      ...
	      @else
	        {{Form::email('employee_email', null, ['class' => 'form-control', 'placeholder' => "Please Enter Employee Email Address"])}} 
	      @endif
	    </div>
